	...
	interface Views
	{
		...
		interface Pages
		{
			interface Account
			{
				...
				String csrLoginPage = "pages/addon:/qrcodeaddon/pages/account/csrLoginPage";
				String customerDetailsPage = "pages/addon:/qrcodeaddon/pages/account/customerDetailsPage";
				String assistcustomerPage = "pages/addon:/qrcodeaddon/pages/account/assistcustomerPage";
				String ordersListPage = "pages/addon:/qrcodeaddon/pages/account/ordersListPage";
				String orderDetailsPage = "pages/addon:/qrcodeaddon/pages/account/orderDetailsPage";
				String CustomerCollectOrderPage = "pages/addon:/qrcodeaddon/pages/account/CustomerCollectOrderPage";
			}

			interface Checkout
			{
				String CheckoutRegisterPage = "pages/checkout/checkoutRegisterPage";
				String CheckoutConfirmationPage = "pages/addon:/qrcodeaddon/pages/checkout/checkoutConfirmationPage";
		...
		interface Fragments
		{
			interface Cart
			{
				...
				String WishlistPopup = "pages/addon:/qrcodeaddon/fragments/cart/wishlistPopup";
				String OrderByUCOID = "pages/addon:/qrcodeaddon/fragments/cart/OrderByUCOID";
				String csrOrderDetails = "pages/addon:/qrcodeaddon/fragments/cart/csrOrderDetails";
				String OrdersListFragmentPage = "pages/addon:/qrcodeaddon/fragments/cart/ordersListFragmentPage";
				String OrderByDateTime = "pages/addon:/qrcodeaddon/fragments/cart/orderByDateTime";
				String PersonalDetails = "pages/addon:/qrcodeaddon/fragments/cart/personalDetails";
				String OrderByCustomerName = "pages/addon:/qrcodeaddon/fragments/cart/orderByCustomerName";
