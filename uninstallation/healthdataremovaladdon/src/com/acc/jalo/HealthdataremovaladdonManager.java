...
import com.acc.constants.HealthdataremovaladdonConstants;



/**
 * This is the extension manager of the Healthdataremovaladdon extension.
 */
public class HealthdataremovaladdonManager extends GeneratedHealthdataremovaladdonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(HealthdataremovaladdonManager.class.getName());
	 ...
	 */
	public static HealthdataremovaladdonManager getInstance()
	{
		return (HealthdataremovaladdonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				HealthdataremovaladdonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public HealthdataremovaladdonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of HealthdataremovaladdonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of HealthdataremovaladdonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of HealthdataremovaladdonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
