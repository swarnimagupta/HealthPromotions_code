...
1. Place the healthpromotionsaddon, qrcodeaddon, bncwebservices, bncwebserviceshmc extensions in custom folder of hybris (location:bin/custom)
2. Now perform following command to include and build qrcodeaddon in the project.
	
	ant addoninstall -Daddonnames="qrcodeaddon, healthpromotionsaddon" -DaddonStorefront.yacceleratorstorefront="<<storefront name e.g. bncstorefront>>"
...
7.	Once the hybris server is started, then system update is required.Update  the hybris Commerce Suite.
	...
	b. Select the checkboxes next to qrcodeaddon, healthpromotionsaddon
