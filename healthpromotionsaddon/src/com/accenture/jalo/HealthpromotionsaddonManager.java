...
/**
 * This is the extension manager of the Healthpromotionsaddon extension.
 */
public class HealthpromotionsaddonManager extends GeneratedHealthpromotionsaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(HealthpromotionsaddonManager.class.getName());
	 ...
	 */
	public static HealthpromotionsaddonManager getInstance()
	{
		return (HealthpromotionsaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				HealthpromotionsaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public HealthpromotionsaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of HealthpromotionsaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of HealthpromotionsaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of HealthpromotionsaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
