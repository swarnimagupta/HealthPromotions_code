...
/**
 * Provides necessary meta information about the healthpromotionsaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.1.0.3
 */
public class HealthpromotionsaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(HealthpromotionsaddonHMCExtension.class.getName());
